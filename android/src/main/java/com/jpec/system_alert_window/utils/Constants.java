...
public class Constants {
    ...
    public static final String CHANNEL = "com.jpec.system_alert_window";
    public static final String BACKGROUND_CHANNEL = "com.jpec.system_alert_window/background";

    public static final String SHARED_PREF_SYSTEM_ALERT_WINDOW = "com.jpec.system_alert_window";
    ...
    public static final String MEET_URL = "meetUrl";
